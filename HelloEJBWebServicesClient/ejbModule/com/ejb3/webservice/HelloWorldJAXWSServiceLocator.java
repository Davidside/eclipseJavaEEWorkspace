...
public class HelloWorldJAXWSServiceLocator extends org.apache.axis.client.Service implements com.ejb3.webservice.HelloWorldJAXWSService {
    ...
    private java.lang.String HelloWorldJAXWSPort_address = "http://localhost:8080/HelloEJBWebServices/HelloWorldJAXWS";
    ...
    public com.ejb3.webservice.HelloWorldJAXWS getHelloWorldJAXWSPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ejb3.webservice.HelloWorldJAXWSServiceSoapBindingStub _stub = new com.ejb3.webservice.HelloWorldJAXWSServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ejb3.webservice.HelloWorldJAXWS.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ejb3.webservice.HelloWorldJAXWSServiceSoapBindingStub _stub = new com.ejb3.webservice.HelloWorldJAXWSServiceSoapBindingStub(new java.net.URL(HelloWorldJAXWSPort_address), this);
                _stub.setPortName(getHelloWorldJAXWSPortWSDDServiceName());
                return _stub;
            }
        }
